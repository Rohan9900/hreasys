                    ...
                    <StyledTable sx={{ minWidth: 650 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                {showsetails === true && <StyledTableCell align="center">Designation</StyledTableCell>}
                                {showsetails === true && <StyledTableCell align="center">Daily wages</StyledTableCell>}
                            ...
                            {attend?.employeesAttendance?.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {showsetails === true && <TableCell align="center">{row?.designation}</TableCell>}
                                        {showsetails === true && <TableCell align="center">{row?.dailyWages}</TableCell>}
                                        <TableCell
                                            align="center"
                                            onClick={() => {
